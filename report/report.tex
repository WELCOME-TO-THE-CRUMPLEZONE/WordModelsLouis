...
Then we sample\footnote{See \cite{bishop2006pattern} Ch. 11 for an explanation of how to sample from a Gaussian.} $z$ from the corresponding component with probability $\mathcal{N}(z| \mu_m, \Sigma_m)$.
